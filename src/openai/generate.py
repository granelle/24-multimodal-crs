...
def call_vision_api(prompt, image_paths, args):
    ...
    if args.model_name == 'gpt-4-vision-CoI':
...
def call_text_api(prompt, args):
    ...
    if args.model_name == 'gpt-4-0125-CoI':
...
if __name__=="__main__":
    ...
    parser.add_argument("--model_path", type=str, default="gpt-4-vision-preview", choices=["gpt-3.5-turbo-0125", "gpt-4-0125-preview", "gpt-4-0125-CoI", "gpt-4-vision-preview", "gpt-4-vision-CoI"])  # gpt-4-vision-preview points to "1106"
    parser.add_argument("--task", type=str, default="description", choices=['description', 'rec_title', 'rec_choice']) 
